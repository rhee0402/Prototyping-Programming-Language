tests(
  ...
  {
    name: 'unify(Clause, Clause for part2.5)',
    code: 'new Subst().unify(new Clause("plus",[new Var("X"), new Var("X")]),\n' +
          '                  new Clause("plus",[new Clause("z"), new Clause("z")]));',
    expected: new Subst().bind("X", new Clause("z"))
  },
  ...
  {
    name: 'unify(Clause, Clause) (extra 1)',
    code: 'new Subst().unify(new Clause("foo", [new Var("X"), new Var("X")]),\n' +
          '                  new Clause("foo", [new Clause("bar"), new Var("Y")]));',
    expected: new Subst().bind("X", new Clause("bar"))
                         .bind("Y", new Clause("bar"))
  },
  {
    name: 'unify(Clause, Clause) (extra 2)',
    code: 'new Subst().unify(new Clause("foo", [new Var("X"), new Var("X")]),\n' +
          '                  new Clause("foo", [new Clause("bar"), new Clause("test")]));',
    shouldThrow: Error
  },
  {
    name: 'unify(Clause, Clause) (extra 3)',
    code: 'new Subst().unify(new Clause("person", [new Clause("alice")]),\n' +
          '                  new Clause("person", [new Var("X")]));',
        expected: new Subst().bind("X", new Clause("alice"))
  },
  {
    name: 'unify(Clause, Clause) (extra 4)',
    code: 'new Subst().unify(new Clause("foo", [new Var("X"), new Var("Y"), new Var("X")]),\n' +
          '                  new Clause("foo", [new Clause("bar"), new Clause("test"), new Var("Y")]));',
    shouldThrow: Error
  },
